...
namespace ViewSwitchingNavigation
{
    ...
    public partial class Shell : Window, IPartImportsSatisfiedNotification
    {
        ...
        private static Uri StudentViewUri = new Uri("/StudentView", UriKind.Relative);
        //public int a = AuthenticationContext.GlobalFinancialYear;
        public Shell()
        {
            InitializeComponent();
            int NextYear = AuthenticationContext.GlobalFinancialYear + 1;
            txtFinancialYear.Text = "20" + AuthenticationContext.GlobalFinancialYear.ToString() + "-" + "20" + NextYear;
        }
