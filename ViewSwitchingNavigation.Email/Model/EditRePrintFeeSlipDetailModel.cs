...
{
    public class EditRePrintFeeSlipDetailModel : BindableBase,IDataErrorInfo
    {
        private Boolean checkboxtesting;
        private string isCheckBoxVisible;
        private int? admino;
        private string name;
        ...
        {
            get { return this.isCheckBoxVisible; }
            set { SetProperty(ref this.isCheckBoxVisible, value); }
        }
        public int? AdminNo
        {
