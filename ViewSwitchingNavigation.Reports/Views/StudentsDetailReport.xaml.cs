...
namespace ViewSwitchingNavigation.Reports.Views
{
    ...
    /// </summary>
    public partial class StudentsDetialReport : UserControl
    {

        public StudentsDetialReport()
        {
            InitializeComponent();
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            reportViewer.LocalReport.ReportPath = "StudentsDetail.rdlc";
            //reportViewer.LocalReport.ReportEmbeddedResource = "ViewSwitchingNavigation.Reports.Reports.StudentsDetail.rdlc";
        ...
        private DataTable GetData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Usp_StudentList", cn);
                ...
                cmd.Parameters.AddWithValue("@GenderOrder", GenderOrder.IsChecked);
