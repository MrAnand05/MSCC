...
namespace ViewSwitchingNavigation.Reports.Views
{
    ...
    /// </summary>
    public partial class FeeBalance : UserControl
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            reportViewer.LocalReport.ReportPath = "FeeBalance.rdlc";
        ...
        private DataTable GetData()
        {
            ...
            //int DuesAmount=0;
            //if(int.TryParse(txtDuesAmnt.Text,out DuesAmount))
            object DuesAmount = txtDuesAmnt.Text;
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@DuesAmount", (String.IsNullOrWhiteSpace(DuesAmount.ToString()) ? DBNull.Value : DuesAmount));
        ...
        private void txtDuesAmnt_PreviewTextInput(object sender, TextCompositionEventArgs e)
        {
